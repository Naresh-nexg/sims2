          ...
          {stats.map((stat, i) => {
            ...
            return (
              ...
              >
                ...
                <h4 className="text-2xl md:text-3xl font-bold text-[var(--color-on-surface)] mb-1 md:mb-2">
                  {stat.value}
                </h4>
                <p className="text-[var(--color-on-surface-variant)] text-xs md:text-sm font-medium">
                  {stat.label}
                </p>
              </Card>
            );
