      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 md:gap-12 lg:gap-8 mb-10 md:mb-16">
          <div className="lg:col-span-4">
            <img
              ...
              className="h-10 md:h-12 object-contain mb-4 md:mb-6"
            />
            <p className="text-[var(--color-on-surface-variant)] text-xs md:text-sm leading-relaxed mb-6 md:mb-8 pr-0 md:pr-4">
              Redefining modern regional medical care through a robust fusion of
              advanced infrastructure, 120 ICU beds, and specialized surgical
              expertise.
            </p>
            <div className="flex items-center gap-3 md:gap-4">
              <a
                href="#"
                className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-[var(--color-surface)] flex items-center justify-center text-[var(--color-primary)] hover:bg-[var(--color-primary)] hover:text-white transition-colors"
              >
          ...
          <div className="lg:col-span-2 lg:col-start-6">
            <h4 className="font-semibold text-sm md:text-base text-[var(--color-on-surface)] mb-4 md:mb-6">
              Quick Links
            </h4>
            <ul className="space-y-3 md:space-y-4">
              <li>
                <a
                  href="#"
                  className="text-xs md:text-sm text-[var(--color-on-surface-variant)] hover:text-[var(--color-primary)] transition-colors"
                >
                  Privacy Policy
                </a>
              </li>
          ...
          <div className="lg:col-span-3">
            ...
            <p className="text-xs md:text-sm text-[var(--color-on-surface-variant)] mb-4">
              Subscribe to receive wellness tips and information about upcoming
              free health camps.
            </p>
            <div className="relative">
              <input
                ...
                className="w-full h-10 md:h-12 pl-3 md:pl-4 pr-10 md:pr-12 rounded-lg bg-[var(--color-surface)] border border-transparent focus:border-[var(--color-primary)] outline-none text-xs md:text-sm transition-colors"
              />
        ...
        <div className="pt-6 md:pt-8 border-t border-[var(--color-border)] flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs md:text-sm text-[var(--color-on-surface-variant)] text-center md:text-left">
            © 2026 SIMS Healthcare (Sainath Institute of Medical Sciences). All
            rights reserved. Precise care with a human touch.
          </p>
