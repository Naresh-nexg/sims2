...
const doctors = [
  ...
  {
    image:
      "https://images.unsplash.com/photo-1537368910025-7028a411df8e?auto=format&fit=crop&q=80&w=500",
    name: "Dr. Sunitha",
  ...
  {
    image:
      "https://images.unsplash.com/photo-1594824436998-d89de6595568?auto=format&fit=crop&q=80&w=500",
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-16">
        <div className="text-center max-w-2xl mx-auto mb-8 md:mb-10">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-[var(--color-on-surface)] tracking-tight">
            Our Core Medical Specialists
          </h2>
          <p className="text-[var(--color-on-surface-variant)] text-base md:text-lg">
            Highly qualified consultants and surgeons committed to delivering
            top-tier medical protocols.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {doctors.map((doctor, index) => (
            <Card
              key={index}
              className="overflow-hidden flex flex-col items-center group"
            >
              ...
              <div className="p-6 md:p-8 w-full text-center bg-white flex-grow flex flex-col justify-center">
                <h3 className="text-lg md:text-xl font-semibold mb-1 text-[var(--color-on-surface)]">
                  {doctor.name}
                </h3>
                ...
                <div className="flex items-center justify-center text-[var(--color-on-surface-variant)] text-xs md:text-sm font-medium gap-1.5 mt-auto">
                  ...
                  <span className="text-left line-clamp-2 md:line-clamp-none">
                    {doctor.experience}
                  </span>
                </div>
              </div>
